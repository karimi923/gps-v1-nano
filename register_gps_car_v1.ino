...
void loop() {
//------------------------------------------------------------------------------
  sensorSMSBAT(caller_id);
  sensorSMSZZZ( caller_id);
  sensorSMSDOOR(caller_id);
  sensorCALLBAT(caller_id);
  sensorCALLZZZ(caller_id);
  sensorCALLDOOR( caller_id); 
while(sim800.available()){
